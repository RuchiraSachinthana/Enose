...
def start_process():
    ...
    while (datetime.now() - start_time).seconds < Wtime:
        ...
        if humidity is not None and temperature is not None:  
            ...
            print( "DHT11 : "  + "Temperature = {0:0.1f}C Humidity = {1:0.1f}% CSV File = {2} Radius = {2} Lenth = {2}".format(temperature,humidity, csvname, fradius, flenth))
        ...
        print(' MQ2:  {0:>6} \n MQ7 : {1:>6} \n MQ135:{2:>6} \n MQ3 : {3:>6} \n '.format(*values))
        print("=================================================================")
        file = open(f"/home/airquality/Desktop/Sensor_R_CSV/{csvname}.csv", "a")
        ...
        file.write("{0:>6},{1:>6},{2:>6},{3:>6}".format(*values)+",{0}".format(temperature)+",{0}".format(humidity)+",{0}".format(fradius) +",{0}".format(flenth) + "\n" )
...
tk.Label(root, text="Enter the CSV Name:").grid(row=1, column=0)
e2 = tk.Entry(root)
